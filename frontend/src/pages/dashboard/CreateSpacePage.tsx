    ...
    <div className="min-h-screen relative  bg-cover bg-center" style={{ backgroundColor: '#2b4162', backgroundImage: 'linear-gradient(315deg, #2b4162 0%, #12100e 74%)' }}>
      <div className=" container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto">
          <h1 className="text-2xl font-bold text-white mb-6">Create a New Space</h1>
              ...
              <form id="create-space-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  <TextArea
                    ...
                    className='h-full hover:shadow-md transition-shadow duration-200 rounded-lg shadow-lg bg-white backdrop-blur-md border border-white/20'
                ...
                <div>
                  <label className=" block text-sm font-medium text-white">Collect Star Rating</label>
                  <div className="mt-2 space-y-2">
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="collectStarRatingYes" className="ml-3 block text-sm font-medium text-white">
                        Yes
                      </label>
                    </div>
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-500"
                      />
                      <label htmlFor="collectStarRatingNo" className="ml-3 block text-sm font-medium text-white">
                        No
                      </label>
                    </div>
                  </div>
